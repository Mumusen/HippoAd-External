...
@Service
@Slf4j
public class UpstreamApiInvokeLogger {
    ...
    public void error(String tag, Object info) {
        if (log.isErrorEnabled()) {
            log.error("[{}] - [{}]", tag, info);
        }
    }

    public void error(String tag, Object info1, Object info2) {
        if (log.isErrorEnabled()) {
            log.error("[{}] - [{}] [{}]", tag, info1, info2);
        }
    }

    public void error(String tag, Object info1, Object info2, Object info3, Object info4, Object info5) {
        if (log.isErrorEnabled()) {
            log.error("[{}] - [{}] [{}] [{}] [{}] [{}] ", tag, info1, info2, info3, info4, info5);
        }
    }
